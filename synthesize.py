...
def prepare_run(args):
	...
	taco_checkpoint = os.path.join('logs-' + run_name, args.model_dir , 'taco_' + args.checkpoint)

	run_name = args.name or args.wavenet_name or args.model
	wave_checkpoint = os.path.join('logs-' + run_name, args.model_dir , 'wave_' + args.checkpoint)
...
def main():
	...
	parser.add_argument('--model_dir', default='default')
