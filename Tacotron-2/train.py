...
def prepare_run(args):
	...
	if(args.transferlearn_dir):
		args.transferlearn_dir = os.path.join(log_dir,args.transferlearn_dir)

	log_dir = os.path.join(log_dir,args.model_dir)
	os.makedirs(log_dir, exist_ok=True)
...
def main():
	...
	parser.add_argument('--model_dir', default='default', help='Name of directory for saving diffrent models in same folder structure')
	...
	parser.add_argument('--transferlearn_dir', default=None, help='Directory of the net you load for transfer learning, ment to be used at beginning of training a new net')
